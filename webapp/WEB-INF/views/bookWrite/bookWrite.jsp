    ...
    <div id="wrap">
		<div id="container">
			...
			<div id="header" class="clearfix">
				<a href=""> <img src="${pageContext.request.contextPath}/assets/images/logo/1_logo.png"></a>
			</div>
			<!-- /header -->
                    ...
                    <ul>
                        <li class="list">
                            <div class="book-img-container">
                                <img src="../img/book/book2.jpeg" alt="" class="img-thumbnail">
                            </div>
                        ...
                        <li class="list">
                            <div class="book-img-container">
                                <img src="../img/book/book2-2.jpeg" alt="" class="img-thumbnail">
                            </div>
                            <div class="info-container">
                        ...
                        <li class="list">
                            <div class="book-img-container">
                                <img src="../img/book/book3-3.jpeg" alt="" class="img-thumbnail">
                            </div>
                            <div class="info-container">
                        ...
                        <li class="list">
                            <div class="book-img-container">
                                <img src="../img/book/book4.jpeg" alt="" class="img-thumbnail">
                            </div>
                            <div class="info-container">
